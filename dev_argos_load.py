...
# Updated:    3/28/2018
# Input Parameters:
#   mode - 'update' = active/dormant tags
#        - 'bulk'   =
#        - 'test'   =
#   new_csv - T/F
...
if __name__ == '__main__':
    ...
    main(mode='update', new_csv=False, days=8)

    # load entire dataset to new <<name?>> database
    #main(mode='bulk', new_csv=False, days=30)

    # same but first re-create csv's
    #main(mode='bulk', new_csv=True, days=140)
